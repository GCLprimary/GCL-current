...
class RelationalTension:
    ...
    def _extract_carry(
        ...
        # Normalize by number of vocab hits — carry represents mean geometric
        # lean of the sentence, not total weight of all named words.
        # Prevents saturation as the named invariant library grows.
        if vocab_hits:
            carry /= len(vocab_hits)
